...
<plugin key="1NukiSmartLock" name="1byRL-Nuki Smart Lock plugin" author="RONELABS Team" version="1.1.1">
    <description>
        ...
        So, Since the lock status is updated on start and the lock<br/>
        shouldn't get out of sync as long as the plugin runs a short<br/>
        polling time should not be required - Recommended: Between 10 to 15 mins<br/>
        <br/>
