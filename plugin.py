...
<plugin key="1NukiSmartLock" name="1byRL-Nuki Smart Lock plugin" author="RONELABS Team" version="1.1.1">
    <params>
        ...
        <param field="Mode2" label="Poll interval            (in minutes)" width="200px">
            <options>
                <option label="1 minute (very high batt. cons.)" value="1"/>
                <option label="3 minutes (high batt. consumption)" value="3"/>
                <option label="5 minutes (medium batt.consumption)" value="5"/>
                <option label="10 minutes (default)" value="10"/>
                <option label="15 minutes (low batt. cons.)" value="15"/>
                <option label="30 minutes (very low batt. cons.)" value="30"/>
            </options>
