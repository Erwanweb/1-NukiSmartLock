...
"""
"""
<plugin key="ZZ-NukiSmartLock" name="Nuki Smart Lock plugin by RONELABS" author="RONELABS Team" version="0.0.2" externallink="https://github.com/Erwanweb/1-NukiSmartLock.git">
    <description>
