...
# Nuki Smart Lock Action API  ---------------------------------------------------

def NukicontrolAPI(APICall):

    resultJson = None
    url = "http://{}:{}/lockAction?nukiId={}&deviceType=0&token={}&action={}".format(Parameters["Address"], Parameters["Port"], Parameters["Username"], parse.quote(APICall, safe="&="))
