...
"""
"""
<plugin key="1NukiSmartLock" name="1byRL-Nuki Smart Lock plugin" author="RONELABS Team" version="0.1.2" externallink="https://github.com/Erwanweb/1-NukiSmartLock.git">
    <params>
        ...
        <param field="Mode1" label="Nuki Bridge local IP" width="200px" required="true" default="192.168.0.1"/>
        <param field="Mode2" label="Nuki Bridge Port" width="40px" required="true" default="8080"/>
        <param field="Mode3" label="Door contact (if external)" required="false" default=""/>
...
class BasePlugin:
    ...
    def onStart(self):
        ...
        if 2 not in Devices:
            Domoticz.Device(Name="Lock", Unit=2, Type=244, Subtype=19,  Used=1).Create()
        ...
        Domoticz.Debug("External door contact = {}".format(self.self.DoorContact))
"""
# Plugin STOP  --------------------------------------------------------
