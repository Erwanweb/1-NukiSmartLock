...
<plugin key="1-NukiSmartLock" name="1byRonelabs - Nuki Smart Lock plugin" author="RONELABS Team" version="0.0.2" externallink="https://github.com/Erwanweb/1-NukiSmartLock.git">
    <description>
    ...
    <params>
        <param field="Address" label="Nuki Bridge local IP" width="200px" required="true" default="127.0.0.1"/>
        <param field="Port" label="Nuki Bridge Port" width="40px" required="true" default="8080"/>
        <param field="Username" label="Nuki SmartLock ID" width="200px" required="true" default=""/>
        <param field="Password" label="Token" width="200px" required="true" default="" default=""/>
