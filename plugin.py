...
<plugin key="1-NukiSmartLock" name="1byRonelabs - Nuki Smart Lock plugin" author="RONELABS Team" version="0.0.2" externallink="https://github.com/Erwanweb/1-NukiSmartLock">
    <params>
